...
export function SuiResultDisplay({ result, onReset }: SuiResultDisplayProps) {
  ...
  const downloadTxt = () => {
    const content = `VANITAS - SUI VANITY
===============================================
...
===============================================
Import the hex private key into Sui Wallet, Suiet, or another Sui wallet.
