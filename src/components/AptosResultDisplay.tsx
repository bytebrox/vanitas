...
/**
 * Aptos vanity result — Ed25519 wallet
 */
...
export function AptosResultDisplay({ result, onReset, onContinueSearch }: AptosResultDisplayProps) {
  ...
  const downloadJson = () => {
    const payload = {
      ...
      importHint: 'Import privateKey (hex) into Petra, Martian, or another Aptos wallet.',
    };
