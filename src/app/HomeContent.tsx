...
/**
 * Home — masthead → full art → open forge ledger
 */
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main id="forge" className="flex-1 px-5 sm:px-8 lg:px-8 xl:px-12 pb-16 scroll-mt-24">
        <ContentWithSide imageSrc="/ascii/side-colosseum.webp" caption="Fig. I — Amphitheatre">
          {result ? (
            <FadeIn>
            ...
            <FadeIn className="space-y-12">
              ...
              <div className="flex flex-wrap gap-x-8 gap-y-2 text-micro uppercase tracking-[0.16em] text-muted pt-2">
                {hasPattern && (
                  <button
                    type="button"
